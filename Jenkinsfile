...
pipeline {
 ...
 post {  
     always {  
             ...
             mail bcc: '', body: "<br>Project: ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br> Build URL : ${env.BUILD_URL}", cc: 'hvasavada@planittesting.com', charset: 'UTF-8', from: '', mimeType: 'text/html', replyTo: '', subject: "STATUS CI: TEST_POC_UNIT -> ${env.JOB_NAME}", to: "nprabhu@planittesting.com";  
         }  
   /* //TO BE UPDATED LATER AS PER REQUIREMENT
         success {  
